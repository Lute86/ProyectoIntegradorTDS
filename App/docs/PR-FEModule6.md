...
| `src/components/layout/AdminLayout/AdminTopbar/AdminTopbar.jsx` | Store importado, `fetchUnreadCount` en `useEffect`, badge numerico en icono de campana, titulo "Consultas" en el map |
| `App/Tasks.md` | 5 tareas del Modulo 6 marcadas como completadas |
...
- **Badge de notificacion:** Muestra el contador de consultas sin leer en el AdminTopbar. Si supera 99, muestra "99+"
