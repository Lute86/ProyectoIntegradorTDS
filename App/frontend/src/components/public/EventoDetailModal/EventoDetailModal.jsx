    ...
    >
      ...
      >
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          {descripcion && (
            <div className="pt-2">
              <h3 className="text-sm font-bold text-slate-700 dark:text-white/80 mb-2">Descripcion</h3>
              <div className="text-sm text-slate-600 dark:text-white/70 leading-relaxed"
