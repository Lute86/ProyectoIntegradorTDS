...
export default function NewsSection({ noticias }) {
  ...
  return (
    <section ref={ref} className={`py-16 bg-gradient-to-b dark:from-slate-700 dark:to-slate-600 from-slate-50 to-white transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      <div className="max-w-content mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-h2 text-body dark:text-white">Ultimas Noticias</h2>
          <p className="text-slate-500 dark:text-white/70 mt-2">Mantenete informado sobre las novedades del instituto</p>
        </div>
