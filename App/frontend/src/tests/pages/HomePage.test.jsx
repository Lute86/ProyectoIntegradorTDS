...
vi.mock('../../../services/carrerasService', () => ({
  carrerasService: { getAll: vi.fn().mockResolvedValue({ data: { data: [{ id: 1, nombre: 'Test', slug: 'test', duracion: '2 anos', descripcion: 'Test', icono: 'test', color: 'from-blue-400 to-blue-600', badgeVariant: 'blue', modalidad: 'Presencial' }] } }), getBySlug: vi.fn() },
}))
